...
<div id="updateDialog">
	<form id="updateForm" method="post" class="form-horizontal">
		<div class="form-group">
			...
			<div class="col-md-9">
				<input id="username" type="text" class="form-control" name="username" maxlength="20" value="${user.username}" required>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label for="email" class="col-md-3 control-label">电话</label>
			<div class="col-md-9">
				<input id="email" type="text" class="form-control" name="email" value="${user.email}" maxlength="20">
			</div>
		</div>
		<div class="form-group">
